...
export const DEFAULT_MODULES: Omit<ModuleConfig, 'id'>[] = [
    ...
    { type: 'hooking-banner', category: 'intro', name: 'Hooking Banner', nameKo: '후킹 배너', isActive: true, order: 1, data: {}, variant: 'A' },
    ...
    { type: 'comparison-table', category: 'benefits', name: 'Comparison Table', nameKo: '비교 테이블', isActive: true, order: 10, data: {}, variant: 'A' },
    { type: 'size-guide', category: 'detail', name: 'Size Guide', nameKo: '사이즈 가이드', isActive: true, order: 11, data: {}, variant: 'A' },
    { type: 'harvest-process', category: 'detail', name: 'Harvest Process', nameKo: '수확 프로세스', isActive: true, order: 12, data: {}, variant: 'A' },
    { type: 'sweetness-check', category: 'detail', name: 'Sweetness Check', nameKo: '당도 확인', isActive: true, order: 13, data: {}, variant: 'A' },
    { type: 'taste-tip', category: 'service', name: 'Taste Tip', nameKo: '맛팁(보관법)', isActive: true, order: 14, data: {}, variant: 'A' },
